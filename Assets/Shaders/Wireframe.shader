// http://answers.unity3d.com/questions/857662/how-to-add-true-transparancy-to-this-wireframe-sha.html

 Shader "LabDesignAR/Wireframe" 
 {
     Properties 
     {
         _WireColor("WireColor", Color) = (0,1,1,1)
         ...
         Pass 
         {
             ...
             half4 frag(g2f IN) : COLOR
             {
                 ...
                 //fade based on dist from center
                  ...
                  return lerp(_FillColor, _WireColor, I);            
             }
